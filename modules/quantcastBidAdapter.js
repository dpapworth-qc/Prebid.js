...
export const QUANTCAST_HTTP = window.location.protocol === 'http:'
export const QUANTCAST_PROTOCOL = QUANTCAST_HTTP ? 'http' : 'https';
export const QUANTCAST_PORT = QUANTCAST_HTTP ? '8080' : '8443';
